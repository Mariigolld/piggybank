        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SharedAccounts_AspNetUsers_User1Id",
                        column: x => x.User1Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SharedAccounts_AspNetUsers_User2Id",
                        column: x => x.User2Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupExpenses_AspNetUsers_PaidByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExpenseShares_GroupExpenses_GroupExpenseId",
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Color", "CreatedAt", "Description", "Icon", "IsShared", "Name", "UserId" },
                values: new object[,]
                {
                    { 1, "#EC4899", new DateTime(2025, 12, 29, 1, 5, 13, 404, DateTimeKind.Utc).AddTicks(1025), "", "🎉", true, "Zabava", null },
                    { 2, "#10B981", new DateTime(2025, 12, 29, 1, 5, 13, 404, DateTimeKind.Utc).AddTicks(1031), "", "🛒", true, "Grosari", null },
                    { 3, "#F59E0B", new DateTime(2025, 12, 29, 1, 5, 13, 404, DateTimeKind.Utc).AddTicks(1032), "", "💡", true, "Računi", null },
                    { 4, "#3B82F6", new DateTime(2025, 12, 29, 1, 5, 13, 404, DateTimeKind.Utc).AddTicks(1034), "", "🚗", true, "Transport", null },
                    { 5, "#EF4444", new DateTime(2025, 12, 29, 1, 5, 13, 404, DateTimeKind.Utc).AddTicks(1035), "", "🏥", true, "Zdravlje", null },
                    { 6, "#8B5CF6", new DateTime(2025, 12, 29, 1, 5, 13, 404, DateTimeKind.Utc).AddTicks(1037), "", "🍽️", true, "Restoran", null },
                    { 7, "#6B7280", new DateTime(2025, 12, 29, 1, 5, 13, 404, DateTimeKind.Utc).AddTicks(1038), "", "📦", true, "Ostalo", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseShares_GroupExpenseId",
                table: "ExpenseShares",
